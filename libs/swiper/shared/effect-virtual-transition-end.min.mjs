...
function effectVirtualTransitionEnd({
  swiper: e, duration: n, transformElements: t, allSlides: r,
}) { const { activeIndex: i } = e; if (e.params.virtualTranslate && n !== 0) { let n; let a = !1; n = r ? t : t.filter((n) => { const t = n.classList.contains('swiper-slide-transform') ? ((n) => { if (!n.parentElement) return e.slides.find((e) => e.shadowRoot && e.shadowRoot === n.parentNode); return n.parentElement; })(n) : n; return e.getSlideIndex(t) === i; }), n.forEach((n) => { elementTransitionEnd(n, () => { if (a) return; if (!e || e.destroyed) return; a = !0, e.animating = !1; const n = new window.CustomEvent('transitionend', { bubbles: !0, cancelable: !0 }); e.wrapperEl.dispatchEvent(n); }); }); } } export { effectVirtualTransitionEnd as e };
